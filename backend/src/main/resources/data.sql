...
('Guardians of the Galaxy', 'A group of intergalactic criminals must work together to stop a powerful villain.', 'PG-13', 'Action', '/posters/Guardians_of_the_Galaxy.png', '/trailers/Guardians_of_the_Galaxy_Trailer.mp4', 'Coming Soon');
